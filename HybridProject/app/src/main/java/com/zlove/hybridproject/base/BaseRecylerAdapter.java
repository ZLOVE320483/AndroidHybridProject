 ...
 */
public abstract class BaseRecylerAdapter<T> extends RecyclerView.Adapter<MyRecyclerViewHolder> implements View.OnLongClickListener, View.OnClickListener {
    ...
    public abstract void convert(MyRecyclerViewHolder holder, int position);
